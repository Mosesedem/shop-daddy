        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            ...
            <h1 className="mt-4 font-display text-5xl md:text-6xl lg:text-7xl leading-[1.05]">
              ...
              <em className="not-italic text-accent">everyday</em> home.
            </h1>
            <p className="mt-6 text-muted-foreground max-w-md">
              Small-batch ceramics, linen textiles and kitchen essentials — made
              slowly, designed to be used, kept, and passed on.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/shop"
                className="btn-primary hover:btn-primary-hover"
                onClick={() => log.event("home:shop-edit:click")}
              >
              ...
              <Link
                ...
                onClick={() => log.event("home:story:click")}
              >
                Our story
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-secondary">
              <img
                src={heroImg}
                alt="Editorial still life of ceramics and linens"
                width={1024}
                height={1280}
            ...
            <div className="hidden md:block absolute -bottom-6 -left-6 card-surface p-4 max-w-[220px] shadow-sm">
              ...
              <div className="mt-1 text-sm">
                On orders over ₦50,000 across Nigeria.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-end justify-between mb-8">
          <div>
            ...
            <h2 className="font-display text-3xl md:text-4xl mt-2">
              A small, careful edit
            </h2>
          </div>
          <Link
            to="/shop"
            className="text-sm underline decoration-accent underline-offset-4"
            onClick={() => log.event("home:view-all:click")}
          >
            View all
          </Link>
        </div>
